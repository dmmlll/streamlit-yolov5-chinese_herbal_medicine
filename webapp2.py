...
if __name__ == '__main__':
    ...
    #标题
    st.set_page_config(page_title="中药饮片",
    ...
    print(opt)
    #多页面操作
    multipage = st.sidebar.radio("查询", ('检测', '中药饮片', '药方','表格'))
    if multipage == '检测':
        # 第一个框检测视频图片
        source = ("图片检测", "视频检测")
        # 下拉选框，侧边栏
        ...
        if source3_index == 0:
            st.write('''
                    ...
                    ''')
        elif source3_index==1:
            st.write('''
            发烧用药：*******************
            
            ''')
        elif source3_index==2:
            st.info("山东官方推荐新冠中药预防药方，市民可在医师指导下应用！:sparkles:")
            st.info(" 普通人群预防：可选用黄芪12g、炒白术9g、防风6g、金银花9g、连翘9g、桑叶6g、炒牛蒡子6g、芦根9g、炙甘草3g以益气固表，清热解毒。\n"
                    " "
        ...
        with st.form("my_form"):
            ...
            st.text_input("病人症状")
            st.text_input("病人用药")
            submitted = st.form_submit_button("点我提交")
            if submitted:
                st.success("提交成功")
